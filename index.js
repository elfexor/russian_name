...
const create = (gender) => {
  ...
  const name =
    gender === 'male'
      ? names_male[random(names_male.length - 1)].name
      : names_female[random(names_female.length - 1)].name;
  const surname =
    gender === 'male'
      ? surnames_male[random(surnames_male.length - 1)].surname
      : surnames_female[random(surnames_female.length - 1)].surname;
